...
export default function AdminAddBulkStockNew() {
  ...
  const handleCreateAddedProducts = (e) => {
    ...
    console.log("check thevalue  ", weights);
    // console.log(Array.isArray(allLabelledStockData)); // Should log true if it's an array
    console.log(allLabelledStockData);
  ...
  console.log('checking label  ', lastCollectionItemId ,'    ', prefix, '    ',  number)
    ...
    const newItemCode = `${prefix}${newNumber}`;
        console.log(newItemCode, "checkingcode"); // Log the generated item code
        return {
          ...createdProduct,
          Quantity: "1",
    ...
    try {
      ...
      if (hasInvalidGrossWt) {
        ...
        const updatedProductsString = addedProducts.map((product) => {
          ...
          if (product.Stones.length > 0) {
              totalStoneWeight = product.Stones.reduce((a, b) => {
                  ...
                  console.log(`Stone: ${b.StoneName}, Weight: ${stoneWeight}`);
                  return a + stoneWeight;
              }, 0);
          }
          totalStoneWeight = parseFloat(totalStoneWeight).toFixed(3);
          console.log(`Total Stone Weight for Product ${product.ItemCode}: ${totalStoneWeight}`);
        ...
        if (rcvdData.Message) {
          ...
          console.log("checking labelformate ", labelFormat);
  ...
  useEffect(() => {
    if (selectedSkuName !== "" && selectedSku) {
      ...
      console.log('checking pro filter1', selectedSku);
      ...
      console.log('checking pro filter2', `${selectedSku.PurityId},${selectedSku.PurityName}`);
    } else {
      setDeleteAll(true);
      // setPartyTypeId("");
      setCategory("");
    ...
    console.log('checking pro filter', productType);
                      ...
                      >
                        ...
                        categoryName.toLowerCase() == "loose diamonds" ? (
                          ...
                          <>
                            ...
                            <div className="bulkStockAddProductDetailsItem">
                            {console.log('Rendering component', purity)}
