    ...
    setAddedProducts((prevProducts) => {
      const updatedProducts = prevProducts.map((product, index) => {
        ...
        const updatedDiamonds = product.Diamonds.map((diamond, sIndex) => {
          ...
          console.log("checkdiamondattribut ", updatedDiamond);
          ...
          //         cut
          //       );
          //       console.log("check matched diamond ", foundData);

          //       if (foundData) {
          //         updatedDiamond.DiamondPurchaseRate =
          //           foundData.DiamondPurchaseRate;
          //       } else {
          //         updatedDiamond.DiamondPurchaseRate = "0";
          //       }
          //     }
